...
List<String> farzname = [
  "Allah Allah azzawajal 'nin mahlukat için tecelli anında melaikenin tesbihi",
  "Sabah ve Akşam Namazları Ardı Oturuşu Bozmadan Yapılan Zikirler",
  "Beş Vakit Namaz Ardı Yapılan Zikirler"
];
