...
List<String> Thurkis = [
  "Subĥane żil mulki vel melekũt.Subĥane żil îzzeti vel ceberũt Subĥanel ĥæyyilleżiy la yemũt Subbũĥun quddũsun Ræbbuna ve Ræbbul melãiketi ver-rũĥ (Namaz öncesi üç kez söylenir)",
...
// " \uFD3E"+(arabicNumber.convert("10"),).toString().toLowerCase()+ "\uFD3F"
  ...
  "(10 مَرَّات) لاَ إِلَهَ إِلاَّ اللّٰهُ وَحْدَهُ لاَ شَرِيكَ لَهُ، لَهُ الْمُلْكُ وَلَهُ الْحَمْدُ يُحْيِي وَيُمِيتُ وَهُوَ عَلٰى كُلِّ شَيْءٍ قَدِيرٌ ",
  "اَللّٰهُمَّ أَجِرْنِي مِنَ النَّارِ  تقول في المرة السابعة (7 مَرَّات )",
...
List<String> secondarturki = [
  "Lailahe illællahu veĥdehũ la şeriykeleh, lehul mulku ve lehul ĥæmdu yuĥyi ve yumiytu vehuve âla kulli şey’in qædiyr. (10 kez)",
  "Ællahumme ecirniy minen-nar (7 kez)",
  "Ællahumme ecirniy ve ecir valideyye bicahi Seyyidil Ebrar Mevlana Muĥæmmedinil Muxŧar ŝællællahu âleyhi ve selleme minennar.",
...
// " \uFD3E"+(arabicNumber.convert("10"),).toString().toLowerCase()+ "\uFD3F"
  ...
  "أَسْتَغْفِرُ اللّٰهَ الْعَظِيمَ لَنَا وَلِوَالِدَيْنَا وَلِلْمُؤْمِنِينَ وَلِلْمُؤْمِنَاتِ وَلِلْمُسْلِمِينَ ولِلْمُسْلِمَاتِ اَلْأَحْيَاءِ مِنْهُمْ وَالْأَمْوَاتِ وَلِمَنْ كَانَ حَقٌّ عَلَيْناَ وَالْوَاجِبَاتُ",
  " حَسْبُنَا اللّٰهُ وَنِعْمَ الْوَكِيلُ   (3 مَرَّات). نِعْمَ الْمَوْلَى وَنِعْمَ النَّصِيرُ. غُفْرَانَكَ رَبَّنَا وَإِلَيْكَ الْمَصِيرُ",
